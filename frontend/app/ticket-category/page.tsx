    ...
    <div className="flex-1 p-4 md:p-8 space-y-6 min-h-full w-full">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-2">
              {canManage
                ...
                : "Lihat kategori tiket yang tersedia."}
            </p>
          </div>
        </div>

        <div className="col-span-1 bg-black text-white p-6 rounded-2xl border-4 border-black">
      ...
      <div className="bg-white border-4 border-black">
        <div className="p-6 bg-black text-white">
          <h2 className="text-xl">Daftar Kategori</h2>
        </div>

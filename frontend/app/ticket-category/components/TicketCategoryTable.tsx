    ...
    <div>
      ...
      <div className="flex items-center justify-between gap-4 mb-5 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          ...
          {role === "admin" && <TicketCategoryForm onSave={handleSave} />}
        </div>
      </div>
            ...
            {filtered.map((cat) => (
              ...
              >
                ...
                <td className="px-5 py-3.5 text-center">
                  <span className="font-head text-[0.6rem] tracking-[0.08em] uppercase bg-[#ffdb33] border-2 border-black shadow-[2px_2px_0_0_#000] px-2.5 py-1 group-hover:bg-white transition-colors duration-100 tabular-nums">
                    {cat.quota.toLocaleString()}
                  </span>
                </td>

                {/* Price */}
                <td className="px-5 py-3.5 font-semibold text-black tabular-nums">
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={5} className="py-14 text-center">
                  <p className="font-head text-base text-black">Tidak ada kategori ditemukan</p>
                  <p className="text-xs text-gray-500 mt-1">Coba kata kunci lain atau tambah kategori baru</p>
                </td>
              </tr>
            )}
          </tbody>
        ...
        <div className="fixed inset-0 bg-black/55 flex items-center justify-center z-50 px-4">
          ...
          >
            ...
            <div className="p-6">
              ...
              <h2 className="font-head text-xl text-black mb-1">Hapus Kategori</h2>
